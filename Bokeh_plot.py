...
if loadFromPickle:
    ...
    for l in class_list:
        location = os.listdir("style/WIKI_STYLE/" + str(l) + "/features/style4096/")
        for file in location:
            sty = (scipy.io.loadmat("style/WIKI_STYLE/" + str(l) + "/features/style4096/" + file)['conv5_1'])
            vectors.append(sty[0])
